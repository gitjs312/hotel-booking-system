...
<body>
    ...
    <main class="my-5 ">
        <h1 class="d-flex justify-content-center">ADMINLOGIN</h1>
                ...
                <div class="col-md-6">
                    <form action="../process.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="adminemail" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Admin Password</label>
                            <input type="password" class="form-control" id="password" name="adminpass" required>
                        </div>
                        <button type="submit" name="adminlogin" class="btn btn-danger">Admin Login</button>
